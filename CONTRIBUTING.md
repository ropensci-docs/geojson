...
- Submit an issue on the [Issues
  page](https://github.com/ropensci/geojson/issues)
...
- Clone your version on your account down to your machine from your
  account, e.g,.
  `git clone https://github.com/<yourgithubusername>/geojson.git`
- Make sure to track progress upstream (i.e., on our version of
  `geojson` at `ropensci/geojson`) by doing
  `git remote add upstream https://github.com/ropensci/geojson.git`.
